...
public class UserDataServiceImpl implements UserDataService {
    ...
    @Override
    public List<UserData> findAllByFavouriteEventCategoriesContains(EventCategory eventCategory) {
        return this.userDataRepository.findAllByFavouriteEventCategoriesContains(eventCategory);
    }
}